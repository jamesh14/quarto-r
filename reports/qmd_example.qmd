...
Additionally, note that in @tbl-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse.

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-sd width=60%}

In @fig-sd we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
